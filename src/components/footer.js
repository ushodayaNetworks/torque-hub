// Create and append the footer to the page
    ...
    <div class="footer-container">
      <div class="footer-content">
        <div class="footer-section">
          <h3>TorqueHub</h3>
          <p>Your trusted marketplace for buying and selling used cars. We simplify the process and help you find the perfect vehicle.</p>
        ...
        <div class="footer-section">
          ...
          <ul class="footer-links">
            ...
            <li><a href="/selling-guide.html">Selling Guide</a></li>
        ...
        <div class="footer-section">
          ...
          <ul class="footer-links">
            <li>
              ...
              123 TorqueHub Ave, Auto City, AC 45678
            </li>
            <li>
      ...
      <div class="footer-bottom">
        <p>&copy; ${new Date().getFullYear()} TorqueHub. All rights reserved.</p>
      </div>
    </div>
  `;
